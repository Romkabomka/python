# Фукнкция dir 
# Функция dir() в Python - это встроенная функция, используемая для исследования обьектов.
print(dir(list))
"""
...
, '__reduce_ex__', '__repr__', '__reversed__', '__rmul__', '__setattr__', '__setitem__', '__sizeof__', '__str__', '__subclasshook
__', 'append', 'clear', 'copy', 'count', 'extend', 'index', 'insert', 'pop', 'remove', 'reverse', 'sort']
"""